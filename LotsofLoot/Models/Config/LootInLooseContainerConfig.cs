...
namespace LotsofLoot.Models.Config
{
    public class LootInLooseContainerConfig
    {
        ...
        /// </summary>
        public Dictionary<MongoId, LootInLooseContainerSpawnLimit> SpawnLimits { get; set; } =
            new()
            {
                // WZ Wallet
                ["60b0f6c058e0b0481a09ad11"] = new() { Keycards = 0 },

                // Simple wallet
                ["5783c43d2459774bbe137486"] = new() { Keycards = 0 },

                // Keycard holder case
                ["619cbf9e0a7c3a1a2731940a"] = new() { Keycards = 2 },

                // Document case
                ["590c60fc86f77412b13fddcf"] = new() { Keys = 3, Keycards = 1 },

                // S I C C organizational pouch
                ["5d235bb686f77443f4331278"] = new() { Keys = 3, Keycards = 1 },

                // Key tool
                ["59fafd4b86f7745ca07e1232"] = new() { Keys = 5 },
        ...
        /// </summary>
        public Dictionary<MongoId, List<MongoId>> Blacklist { get; set; } =
            new()
            {
                // Documents case
