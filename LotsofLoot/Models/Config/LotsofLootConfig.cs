...
namespace LotsofLoot.Models.Config
{
    public class LotsOfLootConfig
    {
        ...
        /// </summary>
        public Dictionary<string, int> LooseLootMultiplier { get; set; } = new Dictionary<string, int>()
        {
            { "bigmap", 5 },
            { "factory4_day", 5 },
            { "factory4_night", 5 },
        ...
        /// </summary>
        public Dictionary<string, int> StaticLootMultiplier { get; set; } = new Dictionary<string, int>()
        {
            { "bigmap", 2 },
            { "factory4_day", 2 },
            { "factory4_night", 2 },
